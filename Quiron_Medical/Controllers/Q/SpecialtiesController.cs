...
namespace Quiron_Medical.Controllers
{
    public class SpecialtiesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,Description")] Specialty specialty)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,Description")] Specialty specialty)
        {
            if (ModelState.IsValid)
            {
